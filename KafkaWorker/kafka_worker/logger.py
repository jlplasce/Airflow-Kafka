...
def get_logger(logging_level, logs_output_file_path=None, logs_rotate_when="midnight", logs_rotate_backup_count=7):
    ...
    logger.debug("Created Logger with Args - logging_level: {logging_level}, "
                 "logs_output_file_path: {logs_output_file_path}, "
                 "logs_rotate_when: {logs_rotate_when}, "
                 "logs_rotate_backup_count: {logs_rotate_backup_count}"
                 .format(**locals()))
